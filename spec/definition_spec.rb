...
describe '#Defintion' do
  ...
  describe('.all') do
    ...
    #   defi1 = Defi.new({name: "to fool someone", album_id: @album.id})
    #   defi1.save
    #   defi2 = Defi.new({name: "to scam someone", album_id: @album.id})
    #   defi2.save
  ...
  describe('#==') do
    it("allows '==' to equate two Defi objects with the same attributes") do
      defi1 = Defi.new({name: "to fool someone", album_id: @album.id})
      defi2 = Defi.new({name: "to fool someone", album_id: @album.id})
